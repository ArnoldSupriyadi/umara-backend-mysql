            ...
            <section id="contact" className="py-20 bg-gray-50">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6" data-aos="fade-up" data-aos-delay="100">
                        ...
                        {/* Card: Address & Hours */}
                        <div className="flex items-start gap-4 p-6 rounded-2xl border border-[#C9A53D]/30 bg-white hover:shadow-md transition-shadow">
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Bintaro Avenue, Jl. MH Thamrin Blok A2 No. 1,<br />South Tangerang, Banten</p>
                                </div>
                                <div>
                                    <h3 className="text-base font-bold text-gray-900 mb-1">Opening Hours</h3>
                                    <p className="text-sm text-gray-600">Daily: 10:00 AM – 10:00 PM</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center justify-center gap-3 w-full py-4 px-6 rounded-2xl text-[#562E12] font-semibold text-base hover:opacity-90 transition-opacity bg-gradient-to-b from-[#efd266] to-[#b9932f]"
                            >
